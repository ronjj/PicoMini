...
#
get_filename_component(filename "/Users/ronaldjabouin/Documents/picominimain/PicoMini/_deps/cimg-subbuild/cimg-populate-prefix/src/master.tar.gz" ABSOLUTE)
get_filename_component(directory "/Users/ronaldjabouin/Documents/picominimain/picomini/_deps/cimg-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-cimg-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-cimg-populate${i}")
